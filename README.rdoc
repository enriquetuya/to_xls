...
== Usage
  ...
  @users.to_xls(:exclude_columns => [:id, :role]) # will exclude columns
  @users.to_xls(:header_transformer => proc{ |headers| headers.map{ |x| x.to_s.upcase }.to_a }) # will execute the Proc over the headers
